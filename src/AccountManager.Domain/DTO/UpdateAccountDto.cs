// <copyright file="UpdateAccountDto.cs" company="PlaceholderCompany">
...
{
    /// <summary>
    /// Represents a data transfer object used to update an existing account.
    /// </summary>
    /// <remarks>
    /// All properties are optional except <see cref="Version"/>, allowing partial updates
    /// while supporting optimistic concurrency control.
    /// </remarks>
