// <copyright file="AccountStatusTransitCommandResponse.cs" company="PlaceholderCompany">
...
{
    /// <summary>
    /// Represents the response returned after an account status
    /// transition command has been successfully processed.
    /// </summary>
    public class AccountStatusTransitCommandResponse
    {
        /// <summary>
