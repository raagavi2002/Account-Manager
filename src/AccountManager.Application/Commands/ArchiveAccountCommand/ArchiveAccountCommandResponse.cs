// <copyright file="ArchiveAccountCommandResponse.cs" company="PlaceholderCompany">
...
{
    /// <summary>
    /// Represents the response returned after executing an archive account command.
    /// Contains details about the account and its archival status.
    /// </summary>
    public class ArchiveAccountCommandResponse
    {
        /// <summary>
